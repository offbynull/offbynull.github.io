`{bm-disable-all}`[arithmetic_code/relation/properties/LessThanProperties.py](arithmetic_code/relation/properties/LessThanProperties.py) (lines 17 to 23):`{bm-enable-all}`
