`{bm-disable-all}`[arithmetic_code/expression/properties/EquivalentFractionProperty.py](arithmetic_code/expression/properties/EquivalentFractionProperty.py) (lines 20 to 37):`{bm-enable-all}`
