`{bm-disable-all}`[arithmetic_code/relation/properties/GreaterThanProperties.py](arithmetic_code/relation/properties/GreaterThanProperties.py) (lines 35 to 66):`{bm-enable-all}`
