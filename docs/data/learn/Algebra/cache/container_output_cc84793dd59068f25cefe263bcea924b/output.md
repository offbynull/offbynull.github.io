`{bm-disable-all}`[arithmetic_code/relation/properties/LessThanOrEqualProperties.py](arithmetic_code/relation/properties/LessThanOrEqualProperties.py) (lines 26 to 32):`{bm-enable-all}`
