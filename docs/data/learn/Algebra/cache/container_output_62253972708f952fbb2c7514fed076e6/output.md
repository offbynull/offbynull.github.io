`{bm-disable-all}`[arithmetic_code/relation/properties/LessThanProperties.py](arithmetic_code/relation/properties/LessThanProperties.py) (lines 26 to 32):`{bm-enable-all}`
