`{bm-disable-all}`[arithmetic_code/relation/properties/LessThanOrEqualProperties.py](arithmetic_code/relation/properties/LessThanOrEqualProperties.py) (lines 35 to 63):`{bm-enable-all}`
