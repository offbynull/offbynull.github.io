`{bm-disable-all}`[arithmetic_code/relation/properties/GreaterThanProperties.py](arithmetic_code/relation/properties/GreaterThanProperties.py) (lines 17 to 23):`{bm-enable-all}`
