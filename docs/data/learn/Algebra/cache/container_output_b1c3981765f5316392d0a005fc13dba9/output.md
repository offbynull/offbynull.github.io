`{bm-disable-all}`[arithmetic_code/relation/properties/GreaterThanProperties.py](arithmetic_code/relation/properties/GreaterThanProperties.py) (lines 26 to 32):`{bm-enable-all}`
