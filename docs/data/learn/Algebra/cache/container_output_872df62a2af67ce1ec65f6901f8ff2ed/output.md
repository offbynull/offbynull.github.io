`{bm-disable-all}`[arithmetic_code/relation/properties/LessThanProperties.py](arithmetic_code/relation/properties/LessThanProperties.py) (lines 69 to 100):`{bm-enable-all}`
