`{bm-disable-all}`[arithmetic_code/expression/properties/DistributiveProperty.py](arithmetic_code/expression/properties/DistributiveProperty.py) (lines 15 to 49):`{bm-enable-all}`
