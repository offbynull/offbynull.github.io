`{bm-disable-all}`[ch10_code/src/profile_hmm/HMMSingleElementAlignment_EmitDelete.py](ch10_code/src/profile_hmm/HMMSingleElementAlignment_EmitDelete.py) (lines 169 to 248):`{bm-enable-all}`
