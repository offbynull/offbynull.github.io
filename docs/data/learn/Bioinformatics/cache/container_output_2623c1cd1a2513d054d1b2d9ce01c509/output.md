`{bm-disable-all}`[ch10_code/src/hmm/MostProbableEmittedSequence_ForwardGraph.py](ch10_code/src/hmm/MostProbableEmittedSequence_ForwardGraph.py) (lines 346 to 377):`{bm-enable-all}`
