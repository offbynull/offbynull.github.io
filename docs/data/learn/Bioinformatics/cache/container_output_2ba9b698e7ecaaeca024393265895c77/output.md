`{bm-disable-all}`[ch10_code/src/hmm/ProbabilityOfEmittedSequence_Naive.py](ch10_code/src/hmm/ProbabilityOfEmittedSequence_Naive.py) (lines 146 to 200):`{bm-enable-all}`
