`{bm-disable-all}`[ch10_code/src/hmm/ViterbiMostProbableHiddenPath_Standard.py](ch10_code/src/hmm/ViterbiMostProbableHiddenPath_Standard.py) (lines 197 to 225):`{bm-enable-all}`
