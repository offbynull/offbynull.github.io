`{bm-disable-all}`[ch10_code/src/hmm/CertaintyOfEmittedSequenceTravelingThroughHiddenPathNode.py](ch10_code/src/hmm/CertaintyOfEmittedSequenceTravelingThroughHiddenPathNode.py) (lines 15 to 28):`{bm-enable-all}`
