...
"STATE_X,-1,-1" [label="X,-1,-1"]
"STATE_D,0,1" -> "STATE_D,0,2" [label="0.49995001499550135"]
"STATE_D,0,1" -> "STATE_E,1,1" [label="0.49995001499550135"]
"STATE_D,0,1" -> "STATE_E,1,2" [label="9.997000899730082e-05"]
"STATE_D,0,2" -> "STATE_E,1,2" [label="1.0"]
"STATE_D,1,1" -> "STATE_D,1,2" [label="9.997000899730082e-05"]
"STATE_D,1,1" -> "STATE_E,2,1" [label="9.997000899730082e-05"]
"STATE_D,1,1" -> "STATE_E,2,2" [label="0.9998000599820054"]
"STATE_D,1,2" -> "STATE_E,2,2" [label="1.0"]
"STATE_D,2,1" -> "STATE_D,2,2" [label="1.0"]
"STATE_D,2,2" -> "STATE_X,-1,-1" [label="1.0"]
"STATE_E,1,0" -> "STATE_D,1,1" [label="0.5999200239928022"]
"STATE_E,1,0" -> "STATE_E,2,0" [label="0.39998000599820055"]
"STATE_E,1,0" -> "STATE_E,2,1" [label="9.997000899730082e-05"]
"STATE_E,1,1" -> "STATE_D,1,2" [label="9.997000899730082e-05"]
"STATE_E,1,1" -> "STATE_E,2,1" [label="9.997000899730082e-05"]
"STATE_E,1,1" -> "STATE_E,2,2" [label="0.9998000599820054"]
"STATE_E,1,2" -> "STATE_E,2,2" [label="1.0"]
"STATE_E,2,0" -> "STATE_D,2,1" [label="1.0"]
"STATE_E,2,1" -> "STATE_D,2,2" [label="1.0"]
"STATE_E,2,2" -> "STATE_X,-1,-1" [label="1.0"]
...
"SYMBOL_None" [label="None", style="dashed"]
"STATE_X,-1,-1" -> "SYMBOL_None" [label="1.0", style="dashed"]
}
```
...
"(0, 'E,1,2')" [label="(0, 'E,1,2')"]
"(1, 'D,2,1')" [label="(1, 'D,2,1')"]
"(1, 'D,2,2')" [label="(1, 'D,2,2')"]
"(1, 'E,2,0')" [label="(1, 'E,2,0')"]
"(1, 'E,2,1')" [label="(1, 'E,2,1')"]
"(1, 'E,2,2')" [label="(1, 'E,2,2')"]
"(2, 'X,-1,-1')" [label="(2, 'X,-1,-1')"]
"(-1, 'D,0,1')" -> "(-1, 'D,0,2')" [label="0.49995001499550135"]
"(-1, 'D,0,1')" -> "(0, 'E,1,1')" [label="0.49995001499550135"]
"(-1, 'D,0,1')" -> "(0, 'E,1,2')" [label="9.997000899730082e-05"]
"(-1, 'D,0,2')" -> "(0, 'E,1,2')" [label="1.0"]
...
"(0, 'D,1,1')" -> "(1, 'E,2,1')" [label="9.997000899730082e-05"]
"(0, 'D,1,1')" -> "(1, 'E,2,2')" [label="0.9998000599820054"]
"(0, 'D,1,2')" -> "(1, 'E,2,2')" [label="1.0"]
"(0, 'E,1,0')" -> "(0, 'D,1,1')" [label="0.5999200239928022"]
"(0, 'E,1,0')" -> "(1, 'E,2,0')" [label="0.39998000599820055"]
"(0, 'E,1,0')" -> "(1, 'E,2,1')" [label="9.997000899730082e-05"]
"(0, 'E,1,1')" -> "(0, 'D,1,2')" [label="9.997000899730082e-05"]
"(0, 'E,1,1')" -> "(1, 'E,2,1')" [label="9.997000899730082e-05"]
"(0, 'E,1,1')" -> "(1, 'E,2,2')" [label="0.9998000599820054"]
"(0, 'E,1,2')" -> "(1, 'E,2,2')" [label="1.0"]
"(1, 'D,2,1')" -> "(1, 'D,2,2')" [label="1.0"]
"(1, 'D,2,2')" -> "(2, 'X,-1,-1')" [label="1.0"]
"(1, 'E,2,0')" -> "(1, 'D,2,1')" [label="1.0"]
"(1, 'E,2,1')" -> "(1, 'D,2,2')" [label="1.0"]
"(1, 'E,2,2')" -> "(2, 'X,-1,-1')" [label="1.0"]
"(2, 'X,-1,-1')" -> "(-1, 'VITERBI_SINK')" [label="1.0"]
}
```
...
Most probable hidden path: [('S,-1,-1', 'E,1,0'), ('E,1,0', 'D,1,1'), ('D,1,1', 'E,2,2')]

Most probable hidden path probability: 0.3598320759682526
</div>
