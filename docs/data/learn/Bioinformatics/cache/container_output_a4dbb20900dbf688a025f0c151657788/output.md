`{bm-disable-all}`[ch10_code/src/hmm/ProbabilityOfEmittedSequence_ForwardGraph.py](ch10_code/src/hmm/ProbabilityOfEmittedSequence_ForwardGraph.py) (lines 144 to 219):`{bm-enable-all}`
