`{bm-disable-all}`[ch10_code/src/profile_hmm/HMMSingleElementAlignment_EmitDelete.py](ch10_code/src/profile_hmm/HMMSingleElementAlignment_EmitDelete.py) (lines 306 to 358):`{bm-enable-all}`
