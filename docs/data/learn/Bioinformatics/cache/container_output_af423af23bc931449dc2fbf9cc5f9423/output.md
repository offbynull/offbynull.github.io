...
The exploded HMM was modified such that index 2 only has the option to B ...
...
The probability of ['z', 'z', 'y'] being emitted when index 2 only has the option to emit from B is 0.7688262748256085.
