`{bm-disable-all}`[ch10_code/src/profile_hmm/HMMSingleElementAlignment_InsertMatchDelete.py](ch10_code/src/profile_hmm/HMMSingleElementAlignment_InsertMatchDelete.py) (lines 130 to 193):`{bm-enable-all}`
