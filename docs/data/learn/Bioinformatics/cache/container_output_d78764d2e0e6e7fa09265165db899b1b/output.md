`{bm-disable-all}`[ch10_code/src/profile_hmm/HMMSingleElementAlignment_InsertMatchDelete.py](ch10_code/src/profile_hmm/HMMSingleElementAlignment_InsertMatchDelete.py) (lines 123 to 186):`{bm-enable-all}`
