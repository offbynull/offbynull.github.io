`{bm-disable-all}`[ch10_code/src/profile_hmm/HMMSingleElementAlignment_EmitDelete.py](ch10_code/src/profile_hmm/HMMSingleElementAlignment_EmitDelete.py) (lines 32 to 146):`{bm-enable-all}`
