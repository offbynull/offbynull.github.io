`{bm-disable-all}`[ch10_code/src/hmm/ProbabilityOfEmittedSequence_Summation.py](ch10_code/src/hmm/ProbabilityOfEmittedSequence_Summation.py) (lines 14 to 68):`{bm-enable-all}`
