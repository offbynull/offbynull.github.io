`{bm-disable-all}`[ch5_code/src/global_alignment/GlobalAlignment_Matrix.py](ch5_code/src/global_alignment/GlobalAlignment_Matrix.py) (lines 10 to 73):`{bm-enable-all}`
