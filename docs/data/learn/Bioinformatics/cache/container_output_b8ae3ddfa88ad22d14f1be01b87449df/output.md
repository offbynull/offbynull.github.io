`{bm-disable-all}`[ch9_code/src/sequence_search/BurrowsWheelerTransform_SquashedFirst.py](ch9_code/src/sequence_search/BurrowsWheelerTransform_SquashedFirst.py) (lines 140 to 164):`{bm-enable-all}`
