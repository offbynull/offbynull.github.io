`{bm-disable-all}`[ch7_code/src/neighbour_detect/EdgeMultiplicityVariant.py](ch7_code/src/neighbour_detect/EdgeMultiplicityVariant.py) (lines 98 to 108):`{bm-enable-all}`
