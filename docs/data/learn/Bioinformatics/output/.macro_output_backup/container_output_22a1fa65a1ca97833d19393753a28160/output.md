`{bm-disable-all}`[ch5_code/src/fitting_alignment/FittingAlignment_Graph.py](ch5_code/src/fitting_alignment/FittingAlignment_Graph.py) (lines 37 to 95):`{bm-enable-all}`
