`{bm-disable-all}`[ch7_code/src/neighbour_detect/NeighbourJoiningMatrix.py](ch7_code/src/neighbour_detect/NeighbourJoiningMatrix.py) (lines 12 to 28):`{bm-enable-all}`
