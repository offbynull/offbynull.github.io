...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \draw[->, >=stealth, line width = 2px, green] (N0_0) to [] node [align=center, midway, color=black] {C\\ —\\ -1.0} (N1_0);
        ...
        \draw[->, >=stealth, line width = 2px, green] (N1_0) to [] node [align=center, midway, color=black] {H\\ —\\ -1.0} (N2_0);
        ...
        \draw[->, >=stealth, line width = 2px, green] (N2_0) to [] node [align=center, midway, color=black] {—\\ F\\ -1.0} (N2_1);
        \draw[->, >=stealth, line width = 2px, gray!40] (N2_0) to [] node [align=center, midway, color=black] {O\\ F\\ 0.0} (N3_1);
        \draw[->, >=stealth, line width = 2px, green] (N2_1) to [] node [align=center, midway, color=black] {O\\ O\\ 1.0} (N3_2);
        ...
        \draw[->, >=stealth, line width = 2px, green] (N3_2) to [] node [align=center, midway, color=black] {I\\ U\\ 0.0} (N4_3);
        ...
        \draw[->, >=stealth, line width = 2px, green] (N4_3) to [] node [align=center, midway, color=black] {R\\ R\\ 1.0} (N5_4);
