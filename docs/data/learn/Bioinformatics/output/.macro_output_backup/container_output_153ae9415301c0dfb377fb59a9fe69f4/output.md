`{bm-disable-all}`[ch7_code/src/phylogeny/AdditiveDistanceMatrixTest_FourPointCondition.py](ch7_code/src/phylogeny/AdditiveDistanceMatrixTest_FourPointCondition.py) (lines 40 to 52):`{bm-enable-all}`
