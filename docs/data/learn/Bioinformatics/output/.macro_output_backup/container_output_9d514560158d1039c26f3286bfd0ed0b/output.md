...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \draw[->, >=stealth, line width = 2px, green] (N0_0) to [] node [align=center, midway, color=black] {T\\ —\\ -1.0} (N1_0);
        ...
        \draw[->, >=stealth, line width = 2px, green] (N1_0) to [] node [align=center, midway, color=black] {A\\ G\\ 0.0} (N2_1);
