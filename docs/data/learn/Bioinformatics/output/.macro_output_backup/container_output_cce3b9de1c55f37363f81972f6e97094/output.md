...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 2px, gray!40] (N2_0) to [] node [align=center, midway, color=black] {G\\ G\\ 1.0} (N3_1);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 2px, gray!40] (N2_1) to [] node [align=center, midway, color=black] {G\\ A\\ 0.0} (N3_2);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 2px, gray!40] (N2_2) to [] node [align=center, midway, color=black] {G\\ G\\ 1.0} (N3_3);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 2px, gray!40] (N2_3) to [] node [align=center, midway, color=black] {G\\ G\\ 1.0} (N3_4);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 2px, gray!40] (N3_2) to [] node [align=center, midway, color=black] {T\\ G\\ 0.0} (N4_3);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
