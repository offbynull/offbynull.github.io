...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \end{pgfonlayer}
        \draw[->, >=stealth, line width = 2px, green] (N2_4) to [] node [align=center, midway, color=black] {A\\ A\\ 1.0} (N3_5);
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \draw[->, >=stealth, line width = 2px, green] (N3_5) to [] node [align=center, midway, color=black] {—\\ A\\ -1.0} (N3_6);
        \begin{pgfonlayer}{bg}
