...
\node[anchor=west] at (0, 1.5) (Oheader) {Original Half};
        ...
        \draw[->, >=stealth, line width = 2px, gray!40] (NO0_0) to [] node [align=center, midway, color=black] {T\\ G\\ 0.0} (NO1_1);
        ...
        \draw[->, >=stealth, line width = 2px, gray!40] (NO1_1) to [] node [align=center, midway, color=black] {A\\ A\\ 1.0} (NO2_2);
        ...
        \draw[->, >=stealth, line width = 2px, gray!40] (NO2_2) to [] node [align=center, midway, color=black] {C\\ C\\ 1.0} (NO3_3);
        ...
        \draw[->, >=stealth, line width = 2px, gray!40] (NO3_3) to [] node [align=center, midway, color=black] {—\\ G\\ -1.0} (NO3_4);
...
\node[anchor=west] at (0, 1.5) (REheader) {Reversed Edge Half};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (0.0, 0.0) (NRE0_0) {-3.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (0.0, -3.75) (NRE0_1) {-2.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (0.0, -7.5) (NRE0_2) {-1.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (0.0, -11.25) (NRE0_3) {0.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (0.0, -15.0) (NRE0_4) {1.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (0.0, -18.75) (NRE0_5) {-1.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (3.75, 0.0) (NRE1_0) {-5.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (3.75, -3.75) (NRE1_1) {-4.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (3.75, -7.5) (NRE1_2) {-3.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (3.75, -11.25) (NRE1_3) {-2.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (3.75, -15.0) (NRE1_4) {-1.0};
        \node[draw = gray, fill = gray, thick, circle, minimum size = 2px] at (3.75, -18.75) (NRE1_5) {0.0};
        ...
        \draw[->, >=stealth, line width = 2px, gray!40] (NRE1_1) to [] node [align=center, midway, color=black] {T\\ G\\ 0.0} (NRE0_0);
...
\end{scope}
                    ...
                    \draw[line width = 4px, blue!50] (NO3_0) to [bend right, looseness=0.6] node [align=center, midway, draw=blue!50, fill=blue!50, text=white] {$-3.0 + -3.0 = -6.0$} (NRE0_0);
        \draw[line width = 4px, blue!50] (NO3_1) to [bend right, looseness=0.6] node [align=center, midway, draw=blue!50, fill=blue!50, text=white] {$-2.0 + -2.0 = -4.0$} (NRE0_1);
        \draw[line width = 4px, blue!50] (NO3_2) to [bend right, looseness=0.6] node [align=center, midway, draw=blue!50, fill=blue!50, text=white] {$0.0 + -1.0 = -1.0$} (NRE0_2);
        \draw[line width = 4px, blue!50] (NO3_3) to [bend right, looseness=0.6] node [align=center, midway, draw=blue!50, fill=blue!50, text=white] {$2.0 + 0.0 = 2.0$\\ MAX} (NRE0_3);
        \draw[line width = 4px, blue!50] (NO3_4) to [bend right, looseness=0.6] node [align=center, midway, draw=blue!50, fill=blue!50, text=white] {$1.0 + 1.0 = 2.0$\\ MAX} (NRE0_4);
        \draw[line width = 4px, blue!50] (NO3_5) to [bend right, looseness=0.6] node [align=center, midway, draw=blue!50, fill=blue!50, text=white] {$0.0 + -1.0 = -1.0$} (NRE0_5);
