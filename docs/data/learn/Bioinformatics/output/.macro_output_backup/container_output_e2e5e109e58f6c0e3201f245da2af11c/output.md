...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 1px, green] (N0_0) to [bend right, looseness=0.3] node [align=center, midway, color=black] {} (N0_4);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \draw[->, >=stealth, line width = 2px, green] (N0_4) to [] node [align=center, midway, color=black] {A\\ A\\ 1.0} (N1_5);
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \draw[->, >=stealth, line width = 2px, green] (N1_5) to [] node [align=center, midway, color=black] {G\\ A\\ -1.0} (N2_6);
        \begin{pgfonlayer}{bg}
