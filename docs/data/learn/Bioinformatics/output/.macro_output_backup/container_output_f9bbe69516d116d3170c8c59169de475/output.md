...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 1px, green] (N2_2) to [bend left, looseness=0.3] node [align=center, midway, color=black] {} (N4_2);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 1px, red] (N2_2) to [bend left, looseness=0.3] node [align=center, midway, color=black] {} (N2_6);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 1px, magenta] (N2_6) to [bend left, looseness=0.3] node [align=center, midway, color=black] {} (N4_6);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \draw[->, >=stealth, line width = 2px, green] (N4_2) to [] node [align=center, midway, color=black] {C\\ C\\ 1.0} (N5_3);
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 2px, gray!40] (N4_6) to [] node [align=center, midway, color=black] {C\\ C\\ 1.0} (N5_7);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 1px, green] (N5_3) to [bend left, looseness=0.3] node [align=center, midway, color=black] {} (N7_3);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 1px, magenta] (N5_7) to [bend left, looseness=0.3] node [align=center, midway, color=black] {} (N7_7);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
        \draw[->, >=stealth, line width = 1px, green] (N7_3) to [bend left, looseness=0.3] node [align=center, midway, color=black] {} (N7_7);
        \end{pgfonlayer}
        \begin{pgfonlayer}{bg}
