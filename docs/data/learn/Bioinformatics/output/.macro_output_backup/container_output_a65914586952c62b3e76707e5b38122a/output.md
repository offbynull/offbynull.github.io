`{bm-disable-all}`[ch5_code/src/local_alignment/LocalAlignment_Matrix.py](ch5_code/src/local_alignment/LocalAlignment_Matrix.py) (lines 10 to 95):`{bm-enable-all}`
