`{bm-disable-all}`[ch7_code/src/neighbour_detect/EdgeMultiplicityExplainer.py](ch7_code/src/neighbour_detect/EdgeMultiplicityExplainer.py) (lines 98 to 108):`{bm-enable-all}`
