...
def main():
    ...
    try:
        ...
        print()
        print(
            f'... and given that {leaf1_id} and {leaf2_id} are neighbours, balding and merging {leaf1_id} and {leaf2_id} results in ...')
        _next_node_id = 0
        ...
        bald_and_merge_neighbours(dist_mat, leaf1_id, leaf2_id, gen_node_id)
        print()
        print('<table>')
        print('<thead><tr>')
        print('<th></th>')
