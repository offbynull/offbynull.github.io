...
from ch7_copy.phylogeny.ExposeNeighbourParent_Optimized import expose_neighbour_parent
from ch7_copy.phylogeny.FindNeighbourLimbLengths_Optimized import find_neighbouring_limb_lengths
from ch7_copy.phylogeny.FourPointCondition import is_additive
from ch7_copy.phylogeny.NeighbourJoiningMatrix import find_neighbours
from ch7_copy.phylogeny.UntrimTree import create_distance_matrix
...
def neighbour_joining_phylogeny(
        ...
        gen_edge_id: Callable[[], E],
        output_dm_callback: Callable[[str, DistanceMatrix[N]], None],
        output_tree_callback: Callable[[str, Graph[N, ND, E, float]], None]
) -> Graph:
    if dm.n == 2:
