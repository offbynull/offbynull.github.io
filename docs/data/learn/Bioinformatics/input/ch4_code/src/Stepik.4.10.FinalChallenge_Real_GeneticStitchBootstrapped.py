...
# Even with the bootstrapping, this algorithm fails miserably. With some tweaking, it might work with the fake spectrum,
# but it doesn't converge to anything of value with the real specturm.
...
subpeptide_len = 7
# bootstrap with Tyrocidine D subpeptides hoping that it'll point to the correct peptide (Tyrocidine A)
subpeptides_next = [p for p, _ in slide_window([99, 128, 113, 147, 97, 186, 186, 114, 128, 163], subpeptide_len, cyclic=True)]
final_peptide_len = 10
max_nonoverlapping = 2
