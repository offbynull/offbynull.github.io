from sequence_search import SuffixArray, SuffixTree, Trie_Basic, Trie_AhoCorasick
...
# _, matched_set = Trie_Basic.mismatch_search(text_sv, patterns_sv, max_mismatch, end_marker_sv)
_, matched_set = Trie_AhoCorasick.mismatch_search(text_sv, patterns_sv, max_mismatch, end_marker_sv)
# _, matched_set = SuffixTree.mismatch_search(text_sv, patterns_sv, max_mismatch, end_marker_sv)
# _, matched_set = SuffixArray.mismatch_search(text_sv, patterns_sv, max_mismatch, end_marker_sv)
